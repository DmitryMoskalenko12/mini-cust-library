...
function matrix(width, height) {
  var matr = new Array(height).fill().map(function () {
  ...
  while (startCol <= endCol && startRow <= endRow) {
    ...
    for (var _i = endCol; _i >= startCol; _i--) {
      matr[endRow][_i] = counter;
      counter++;
    }
